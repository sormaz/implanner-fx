...
import edu.ohiou.mfgresearch.labimp.fx.Xform;
...
public class testCameraViewPointFinalCorrectedZ extends Application {
...
//		Point2D ctrl1 = new Point2D.Double(40,30);
//		Point2D ctrl2 = new Point2D.Double(70,30);
//		CubicCurveIMPlanner cc = new CubicCurveIMPlanner(start, end, ctrl1, ctrl2);
//		CubicCurveIMPlanner cc = new CubicCurveIMPlanner();
//		Swing2DConverter ccFX = new Swing2DConverter(cc);
//		
//		targetList.addAll(ccFX.getFXShapes());
		
//		xAxis.setStrokeWidth(10);
//		yAxis.setStrokeWidth(10);
//		zAxis.setStrokeWidth(10);
				
//		targetList.add(xAxis);
//		targetList.add(yAxis);
//		targetList.add(zAxis);
...
//					Sphere target = new Sphere(10);
					...
					if(y > 0) {
						...
						target.setMaterial(new PhongMaterial(Color.YELLOW));
					}
